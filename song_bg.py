...
def remove_silence_from_file(
    ...
    try:
        ...
        sound, background = split_singing_background(y, sample="all")
...
def get_train_list():
    train = pd.read_csv("../data/resampled_train.csv", parse_dates=["date"])
...
def main():
    ...
    train_audio_infos = train_list[["ebird_code", "filename"]].values.tolist()
    source_dir = TRAIN_AUDIO_DIRS
    singing_output_dir = TRAIN_SINGING_DIRS
    background_output_dir = TRAIN_BACKGROUND_DIRS
